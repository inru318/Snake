...
function main() {
  ...
  //set eat food  and bomb
    for(var k = 0 ; k < 8 ; k++){
      ...
      foodX[k] = randomInt(980);
      foodY[k] = randomInt(500);
    }
    for(var k = 0 ; k < 20 ; k++){
      bombX[k] = randomInt(980);
      bombY[k] = randomInt(500);
    }
  ...
  function drawScene(time) {
    ...
    for(var kk = 0 ; kk < 20 ; kk++){
      ...
      if( translation[0]  > bombX[kk] && translation[0] < bombX[kk] + 13 && translation[1]  > bombY[kk] && translation[1] < bombY[kk]+13 ){
          ...
          document.getElementById("heart"+ heart).src="image/heterosexuality.png";
